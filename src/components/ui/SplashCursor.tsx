...
function SplashCursor({
  ...
  `
    ...
    function generateColor() {
      if (!COLORFUL) {
         let c = hexToRgb(COLOR) || { r: 0, g: 1, b: 1 };
         c.r *= 0.15;
         c.g *= 0.15;
         c.b *= 0.15;
         return c;
    ...
    window.addEventListener('mousemove', (e) => {
      ...
      if (!pointer.down) updatePointerDownData(pointer, -1, scaleByPixelRatio(e.clientX), scaleByPixelRatio(e.clientY));
      let posX = scaleByPixelRatio(e.clientX);
      let posY = scaleByPixelRatio(e.clientY);
  ...
  }, [SIM_RESOLUTION, DYE_RESOLUTION, CAPTURE_RESOLUTION, DENSITY_DISSIPATION, VELOCITY_DISSIPATION, PRESSURE, PRESSURE_ITERATIONS, CURL, SPLAT_RADIUS, SPLAT_FORCE, SHADING, COLOR_UPDATE_SPEED, BACK_COLOR, TRANSPARENT, COLORFUL, COLOR]);
